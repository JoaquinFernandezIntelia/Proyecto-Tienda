...
function almacenar_pedidos() {
    ...
    if (isset($_POST['codigo_producto'])) {
        ...
        if ($producto) {
            ...
            // Redirigir de vuelta a la página de componentes
            header("Location: index.php?controlador=productos&action=componentes");
            exit;
        }
    }
    
    // Si no hay acciones, mostrar el carrito
...
if (isset($_GET['remove']) && isset($_GET['producto_id'])) {
